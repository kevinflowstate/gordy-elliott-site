...
export const metadata: Metadata = {
  ...
  description: "How SHIFT Coaching handles client information.",
};

const sections = [
  {
    title: "Information SHIFT handles",
    body: "SHIFT stores account and contact details, coaching plans, messages, check-ins, progress photos, training and nutrition logs, consultation answers, and any health, injury or cycle information you choose to provide. If you connect a supported app through Terra, SHIFT may also receive sleep, recovery, activity and nutrition summaries from that provider.",
  },
  {
  ...
  },
  {
    ...
    body: "SHIFT may send relevant coaching context to contracted AI service providers to produce summaries or suggestions. Gordy remains responsible for coaching decisions. AI output can be incomplete or wrong and should not be treated as medical advice.",
  },
  {
    title: "Who receives information",
    body: "Information is available to Gordy and authorised service providers needed to operate SHIFT, such as hosting, authentication, database, email, notification, AI and connected-app providers. Information is not sold. Providers are given only the access needed to deliver their service.",
  },
  {
  ...
  },
  {
    ...
    body: "SHIFT uses access controls and encrypted connections to protect information, but no online service can promise absolute security. SHIFT is intended for Gordy's coaching clients and is not directed to children under 16.",
  },
];
    ...
    <main className="min-h-screen bg-[#0a0a0a] px-5 py-10 text-white sm:px-8 sm:py-16">
      <article className="mx-auto max-w-3xl">
        ...
        <p className="mt-8 text-base leading-7 text-[#d3d4dc]">
          This policy explains how SHIFT Coaching by Gordy Elliott handles information when you use the website, PWA or iOS app.
        </p>
        ...
        <div className="mt-10 space-y-9">
          ...
          <section>
            ...
            <p className="mt-3 text-[15px] leading-7 text-[#c3c4cd]">
              Existing clients can contact Gordy through DM in SHIFT or use the contact details in their coaching welcome email. For account-access help, visit the <Link href="/support" className="text-[#f06be3]">support page</Link>.
            </p>
          </section>
        </div>
      </article>
