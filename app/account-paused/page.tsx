  ...
  return (
    <main className="dark flex min-h-dvh items-center justify-center bg-[#0A0A0A] px-5 py-12 text-white">
      <div className="w-full max-w-lg border-y border-white/10 py-10 text-center">
        <Image src="/images/shift-logo.svg" alt="SHIFT" width={48} height={48} className="mx-auto h-12 w-auto" />
        <div className="mt-5 text-[11px] font-bold uppercase tracking-[0.18em] text-[#E667D6]">SHIFT Coaching</div>
