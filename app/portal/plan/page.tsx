...
const phaseIcons: Record<string, string> = {
  ...
  nutrition: "M12 2.25v1.5m0 16.5v1.5M4.5 12H3m18 0h-1.5M5.636 5.636l1.061 1.061m10.607 10.607l1.06 1.06M5.636 18.364l1.061-1.06m10.607-10.607l1.06-1.061M16 12a4 4 0 11-8 0 4 4 0 018 0z",
  habits: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.066 2.573c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.573 1.066c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.066-2.573c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z",
  mindset: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z",
...
function getPhaseIcon(name: string): string {
  ...
  if (lower.includes("nutrition") || lower.includes("meal") || lower.includes("food") || lower.includes("fuel")) return phaseIcons.nutrition;
  if (lower.includes("habit") || lower.includes("daily") || lower.includes("routine") || lower.includes("sleep")) return phaseIcons.habits;
  if (lower.includes("mindset") || lower.includes("mental") || lower.includes("reflect")) return phaseIcons.mindset;
