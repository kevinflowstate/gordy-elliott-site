...
- App Store screenshot draft: six opaque `1284 x 2778` iPhone JPEGs generated from the fictional Demo Client candidate and visually inspected.

## App Store Connect state

- Version 1.0 listing copy, keywords, categories, support details and review contact are saved.
...
- Final screenshots are recaptured from the approved production build and uploaded.
