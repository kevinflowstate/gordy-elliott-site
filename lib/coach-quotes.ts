...
export const COACH_NOTES: CoachNote[] = [
  ...
  { line: "Consistency beats intensity every week of the year. Just keep turning up.", tag: "AT CAPACITY" },
  { line: "The session you don't want to do is usually the one that moves you most.", tag: "Gordy" },
  { line: "Log it even when it's average. Honest data is what we actually coach off.", tag: "AT CAPACITY" },
  { line: "Sleep and protein aren't the boring bits. They're the whole foundation.", tag: "Gordy" },
  { line: "Progress is quiet. It rarely feels like much until you look back a month.", tag: "AT CAPACITY" },
  { line: "One good decision now makes the next one easier. Stack them.", tag: "Gordy" },
  { line: "You're not behind. You're exactly where the work you've done has put you.", tag: "AT CAPACITY" },
  { line: "Train the standard, not the mood. The mood will catch up.", tag: "Gordy" },
  { line: "Missed a day? Fine. Don't miss two. That's the whole game.", tag: "AT CAPACITY" },
  { line: "Hydration, steps, sleep. Win the basics before you chase the clever stuff.", tag: "Gordy" },
  { line: "Discipline is just remembering what you actually want.", tag: "AT CAPACITY" },
  { line: "Show me a tough week logged honestly and I'll show you someone who's winning.", tag: "Gordy" },
  { line: "The plan only works at the speed you work it. Today counts.", tag: "AT CAPACITY" },
  { line: "Don't aim for perfect. Aim for repeatable.", tag: "Gordy" },
  { line: "Recovery is part of training, not a reward for it. Take it seriously.", tag: "AT CAPACITY" },
  { line: "Effort you can measure is effort we can improve. Keep tracking it.", tag: "Gordy" },
  { line: "Small and steady is still moving. Comparison is the only thing that stalls you.", tag: "AT CAPACITY" },
  { line: "You built the habit of starting. Now build the habit of finishing.", tag: "Gordy" },
  { line: "On the hard days, shrink the goal. Ten honest minutes still counts.", tag: "AT CAPACITY" },
  ...
  { line: "Strong isn't a look. It's what showing up every week turns you into.", tag: "AT CAPACITY" },
  { line: "Fuel the work. Under-eating to train hard is a fight you'll lose.", tag: "Gordy" },
  { line: "Momentum is fragile early and unstoppable later. Protect the early days.", tag: "AT CAPACITY" },
  { line: "Decide once, then stop negotiating with yourself every morning.", tag: "Gordy" },
  { line: "The goal isn't to never slip. It's to come back faster every time.", tag: "AT CAPACITY" },
