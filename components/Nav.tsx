  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[1000] backdrop-blur-[24px] backdrop-saturate-[1.2] px-8 transition-colors duration-300 ${
        scrolled
          ? "bg-[rgba(255,255,255,0.95)] border-b border-[rgba(224,64,208,0.1)]"
    ...
    >
      <div className="max-w-[1200px] mx-auto flex justify-between items-center h-[72px]">
        ...
        <Link
          href="/login"
          className="bg-accent text-white px-6 py-2.5 rounded-lg font-semibold text-[0.85rem] no-underline transition-all duration-300 hover:bg-accent-light hover:-translate-y-px hover:shadow-[0_0_20px_rgba(224,64,208,0.4)]"
        >
          Client Login
        </Link>
      </div>
