export default function AdminBackground() {
  return (
    <div className="admin-bg fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      {/* Cog - bottom right */}
      <svg className="absolute bottom-[15%] right-[8%] w-[160px] h-[160px] opacity-[0.10]" viewBox="0 0 160 160" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="1">
      ...
      <svg className="absolute top-[17%] left-[11%] w-[70px] h-[70px] opacity-[0.10]" viewBox="0 0 70 70" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="0.8">
      ...
      <svg className="absolute top-[45%] left-0 w-[300px] h-[40px] opacity-[0.08]" viewBox="0 0 300 40" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="1.5">
        ...
        {/* Flow dots */}
        <circle cx="40" cy="20" r="1.5" fill="rgba(226,184,48,0.4)" stroke="none" />
        <circle cx="80" cy="20" r="1.5" fill="rgba(226,184,48,0.3)" stroke="none" />
        <circle cx="170" cy="20" r="1.5" fill="rgba(226,184,48,0.3)" stroke="none" />
        <circle cx="220" cy="20" r="1.5" fill="rgba(226,184,48,0.2)" stroke="none" />
      </svg>

      {/* Pipe - vertical right (moved inward) */}
      <svg className="absolute top-[55%] right-[12%] w-[30px] h-[180px] opacity-[0.06]" viewBox="0 0 30 180" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="1.5">
        ...
        <circle cx="15" cy="35" r="1.5" fill="rgba(226,184,48,0.3)" stroke="none" />
        <circle cx="15" cy="130" r="1.5" fill="rgba(226,184,48,0.3)" stroke="none" />
      </svg>

      {/* I-beam - center-left */}
      <svg className="absolute top-[65%] left-[15%] w-[50px] h-[60px] opacity-[0.08] rotate-12" viewBox="0 0 50 60" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="0.8">
      ...
      <svg className="absolute bottom-[8%] left-[30%] w-[200px] h-[20px] opacity-[0.08]" viewBox="0 0 200 20" fill="none" stroke="rgba(226,184,48,1)" strokeWidth="0.5">
        <line x1="5" y1="10" x2="195" y2="10" />
        <line x1="5" y1="3" x2="5" y2="17" />
        <line x1="195" y1="3" x2="195" y2="17" />
        <polygon points="5,10 12,7 12,13" fill="rgba(226,184,48,0.3)" stroke="none" />
        <polygon points="195,10 188,7 188,13" fill="rgba(226,184,48,0.3)" stroke="none" />
      </svg>
