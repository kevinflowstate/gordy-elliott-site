...
const navItems = [
  ...
  { href: "/admin/inbox", label: "DM", icon: "M8 10h8m-8 4h5m-7 6h12a2 2 0 002-2V8a2 2 0 00-.586-1.414l-4-4A2 2 0 0014 2H6a2 2 0 00-2 2v14a2 2 0 002 2z" },
  { href: "/admin/community", label: "SHIFT Community", icon: "M17 20h5v-2a4 4 0 00-4-4h-1m0 6H7m10 0v-2c0-2.21-1.79-4-4H7a4 4 0 00-4 4v2h4m10 0H7m3-10a4 4 0 110-8 4 4 0 010 8zm8 2a3 3 0 100-6" },
  { href: "/admin/ai", label: "AT CAPACITY AI", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
  { href: "/admin/checkin-forms", label: "Form Builder", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
      ...
      <aside className={`fixed top-0 left-0 h-full w-[260px] bg-[#0A0A0A] border-r border-[rgba(255,255,255,0.06)] backdrop-blur-[20px] z-50 flex flex-col transition-transform duration-300 ${collapsed ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}>
        <div className="px-6 py-7 border-b border-[rgba(255,255,255,0.06)]">
          <Link href="/admin" className="flex items-center gap-3 no-underline">
            ...
            <span className="font-heading text-base font-extrabold tracking-wide text-white"><span className="text-accent-bright">AT</span> CAPACITY</span>
          </Link>
        </div>
