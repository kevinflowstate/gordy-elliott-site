...
const allNavItems: PortalNavItem[] = [
  ...
  { href: "/portal/community", label: "SHIFT Community", icon: "M17 20h5v-2a4 4 0 00-4-4h-1m0 6H7m10 0v-2c0-2.21-1.79-4-4-4H7a4 4 0 00-4 4v2h4m10 0H7m3-10a4 4 0 110-8 4 4 0 010 8zm8 2a3 3 0 100-6", tiers: ["coached", "premium", "vip", "ai_only"], programmes: ["shift"] },
  ...
  { href: "/portal/connected-apps", label: "Health & Capacity", icon: "M13.5 6.75h3.75A2.25 2.25 0 0119.5 9v6A2.25 2.25 0 0117.25 17.25H13.5m-3-10.5H6.75A2.25 2.25 0 004.5 9v6a2.25 2.25 0 002.25 2.25H10.5m-3-5.25h9", tiers: ["coached", "premium", "vip", "ai_only"] },
            ...
            return (
              ...
              >
                ...
                {item.href === "/portal/inbox" && inboxUnreadCount > 0 && (
                  <span className="ml-auto rounded-full bg-accent-bright px-2 py-0.5 text-[10px] font-bold text-black">
