...
export default function Footer() {
  return (
    <footer className="pt-20 pb-10 px-8 border-t border-[rgba(0,0,0,0.06)] bg-bg-primary relative">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[rgba(224,64,208,0.15)] to-transparent" />
      ...
      <div className="max-w-[1200px] mx-auto mt-8 pt-6 border-t border-[rgba(0,0,0,0.06)] text-center text-[0.78rem] text-text-muted">
