...
export default function Footer() {
  return (
    <footer className="pt-20 pb-10 px-8 border-t border-[rgba(255,255,255,0.03)] bg-bg-primary relative">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[rgba(16,185,129,0.15)] to-transparent" />

      <div className="max-w-[1200px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12">
        <div className="flex flex-col gap-4">
          <span className="font-heading font-extrabold text-[0.95rem] text-text-primary">Gordy Elliott</span>
          <p className="text-text-muted text-[0.85rem] leading-[1.7] max-w-[280px]">
            Private coaching for driven professionals who want to take control of their health, mindset, and physique - without burning out.
          </p>
        </div>
        ...
        <div>
          ...
          {[
            { href: "/#shift-system", label: "The SHIFT System" },
        ...
        <div>
          <h4 className="font-heading text-[0.8rem] font-bold mb-4 text-text-primary uppercase tracking-[1px]">Connect</h4>
